...
namespace InsightClientLibrary
{
        ...
        public List<LockableElement> GetLockElement(string destinationIrdManagmentIp, string destinationIrdName, string destinationIrdModel, ServiceGraph graph, GraphElement source, GraphElement elementToLock)
        {
                        ...
                        case "mbr":
                            switch (attributeName)
                            {
                                ...
                                case "Multicast Out BU MUC":// belongs to MBR element
                                    ...
                                    break;
                                case "Profile 1 Port":
                                    port = attribute.ObjectAttributeValues[0].displayValue;
                                    break;
                                default:
                                    break;
                            }
            ...
            if (elementType.Equals("Downlink") || elementType.Equals("Monitoring"))
            {
                ...
                */
                ...
                {
                    multiLockable = new MultiLockableElement(multicastEHAMain, multicastEHABackup, port, sourceIPMain, sourceIPBackup, downlinkFrequency, modulation, downlinkPolarity,
                                                    downlinkSatellite, transponder, FEC, rollOff, downlinkSymbolRate, destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, Pop.ToLower(), serviceID, source, elementToLock);
                    answer.Add(multiLockable);
                }
                if (Pop.ToLower().Equals("muc") || Pop.Equals(""))
                {
                    multiLockable = new MultiLockableElement(multicastMUC, multicastMUCBackup, port, sourceIPMain, sourceIPBackup, downlinkFrequency, modulation, downlinkPolarity,
                                downlinkSatellite, transponder, FEC, rollOff, downlinkSymbolRate, destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, Pop.ToLower(), serviceID, source, elementToLock);
                    if (answer.Count > 0)
                    {
            ...
            else
            {
                ...
                if (Pop.ToLower().Equals("eha") || Pop.Equals(""))
                {
                    iPLockable = new IPLockableElement(multicastEHAMain, multicastEHABackup, port, sourceIPMain, sourceIPBackup, destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, Pop.ToLower(), serviceID, source, elementToLock);
                ...
                if (Pop.ToLower().Equals("muc") || Pop.Equals(""))
                {
                    iPLockable = new IPLockableElement(multicastMUC, multicastMUCBackup, port, sourceIPMain, sourceIPBackup, destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, Pop.ToLower(), serviceID, source, elementToLock);
                    if (answer.Count > 0)
                    {
    ...
    public class RFLockableElement : LockableElement
    {
        ...
        */
        ...
        public RFLockableElement(string destinationIrdManagmentIp, string destinationIrdName, string destinationIrdModel, string pop, string serviceID, GraphElement source, GraphElement lockableElement) :
                                        base(destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, pop, serviceID, source, lockableElement)
        {
            this.downlinkLocalOsscilator = new List<string>();
        }
    ...
    {
        /// <summary> </summary>
        public IPLockableElement(string multicastMain, string multicastBackup, string port, string sourceIpMain, string sourceIpBU, string destinationIrdManagmentIp,
    ...
    public class MultiLockableElement : RFLockableElement
    {
        ...
        /// </summary>
        /// <returns></returns>
        public MultiLockableElement(string multicastMain, string multicastBackup, string port, string sourceIpMain, string sourceIpBU, string downlinkFrequency, string modulation, string downlinkPolarity,
        ...
        /// </summary>
        /// <returns></returns>
        public MultiLockableElement(IPLockableElement iPLockable,
                                    string destinationIrdManagmentIp, string destinationIrdName, string destinationIrdModel, string pop, string serviceID, GraphElement source, GraphElement lockableElement) :
            base(destinationIrdManagmentIp, destinationIrdName, destinationIrdModel, pop, serviceID, source, lockableElement)
        {
            this.multicastMain = iPLockable.multicastMain;
            this.multicastBackup = iPLockable.multicastBackup;
            this.sourceIpMain = iPLockable.sourceIpMain;
            this.sourceIpBU = iPLockable.sourceIpBU;
        }
        /// <summary> </summary>
        public string multicastMain { get; set; }
        /// <summary> </summary>
    ...
    public abstract class LockableElement
    {
...

        {
            ...
            this.elementName = _lockableElement.CurrentElement.name;
            this.elementType = _lockableElement.CurrentElement.objectType.name;
        }
        /// <summary>
        /// 
        /// </summary>
